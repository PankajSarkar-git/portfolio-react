          ...
          <div className="section-container">
            <div className="section-titel">
              ...
              <p>
                ...
                <a
                  target="_blank"
                  href="https://drive.google.com/file/d/1FlgIA21tiaujQibRw1f2bH3N5r1hdJxa/view?usp=sharing"
                >
                  HERE
                </a>
              </p>
            ...
            <div className="container resume-container">
              ...
              <div className="resume-item">
                ...
                <p>
                  <em>
                    Learned Front-End web development using the React. Worked on
                    collaborative projects and improved a lot on Communication
                    and leadership skills.
                  </em>
                </p>
                <ul>
                  <li>
                    <a href="https://namastedev.com/namaste-react/">
                      Namaste Dev
                    </a>
                  </li>
                  <li>
                    <em>Check my certificate</em>
                    <a
              ...
              <div className="resume-item">
                ...
                <h5>2018-2021</h5>
                <p>
                  <em>Completed my Graduation from this College.</em>
                </p>
                <ul>
                  <li>
                    <a href="http://www.falakatacollege.org.in/index.aspx">
                      Falakata College
                    </a>
                  </li>
                </ul>
              ...
              <div className="resume-item">
                ...
                <ul>
                  <li>
                    <a href="#">SHILBARIHAT HIGH SCHOOL</a>
                  </li>
                </ul>
              </div>
            </div>
